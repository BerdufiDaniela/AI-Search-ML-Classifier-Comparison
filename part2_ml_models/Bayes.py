...
#//////////////////////////////////////////////////////////////////////////////
#kalw ton Naive Bayes Bernoulli ths bibliothhkhs
...
def plot_accuracy_table(X_train, y_train, X_test, y_test):
    ...
    for size in training_sizes:
        ...
        naive_bayes_classifier.fit(X_train_subset, y_train_subset)

        y_train_pred = naive_bayes_classifier.predict(X_train_subset)
...
def plot_precision_recall_curve(X, y):
    # Predictions
    y_scores = naive_bayes_classifier.predict(X)
    ...
    plt.title('Precision-Recall Curve for library bayes')
    plt.legend()
    plt.show()
...
plot_learning_curve(estimator=naive_bayes_classifier, title='Learning Curve for library bayes',
                    X_for_val=X_train,
                    y_for_val=y_train,
...
plot_accuracy_table(X_train, y_train, X_test, y_test)
# Calculate accuracy
